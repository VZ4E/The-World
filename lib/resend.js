...
<body style="margin:0;padding:0;background:#0d0f14;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#e2e8f0">
  <div style="max-width:600px;margin:0 auto;padding:24px 16px">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px">
      <div style="width:32px;height:32px;background:#4f74f3;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:14px;flex-shrink:0">RS</div>
      <span style="color:#fff;font-weight:600;font-size:16px">Respawn Signal</span>
    ...
    <div style="color:#475569;font-size:12px;text-align:center">
      Respawn Signal · Brand intelligence for gaming creators<br/>
